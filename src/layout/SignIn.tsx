...
const SignIn = () => {
    ...
    <Container>
        ...
        <Box>
            ...
            return(
                <Flex sx={{ flexDirection: 'column', height: '50vh', mt: 60, justifyContent: 'space-between', alignItems: 'center' }} >
                    ...
                    <Text mt={2}>
                        ...
                        <Link sx={{textDecoration: 'underline'}} href="https://metamask.io" target="_blank">
                            https://metamask.io
                        </Link>{' '}
                        and install it.
                    </Text>    
